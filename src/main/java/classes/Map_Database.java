...
public final class Map_Database {
	...
	Level level1 = new Level(conductor1, conveyor1, food1, song1, circle1[0], spawner1);
	Level level2 = new Level(conductor2, conveyor2, food2, song2, circle2[0], spawner2);
	Level level3 = new Level(conductor3, conveyor3, food3, song3, circle3[0], spawner3);
	// get hitcircles
